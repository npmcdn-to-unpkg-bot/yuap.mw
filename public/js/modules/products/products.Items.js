yellApp.products.items = [{
    ...
    desc: {
        text: "Комбинация от oodji выполнена из полупрозрачной черной ткани с отделкой из кружева. Детали: регулируемые бретели.",
        params: [{
            title: "Состав",
            value: "Полиамид - 90%, Эластан - 10%"
        },
        {
            title: "Длина",
            value: "58 см"
        ...
        {
            title: "Вырез/воротник",
            value: "Глубокое декольте"
        },
        {
            title: "Тип размера",
            value: "Стандартный"
